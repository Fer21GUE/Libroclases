...
public class NotaController {
    ...
    @GetMapping("/profesor/{profesorId}") public ResponseEntity<?> porProfesor(@PathVariable Long profesorId){return ResponseEntity.ok(notaService.listarPorProfesor(profesorId));}
